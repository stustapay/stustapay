...
*UserApi* | [**createFinanzorga**](docs/UserApi.md#createfinanzorga) | **POST** /user/update-user-roles | Update roles of a given user
...
## Documentation for Models
 ...
 - [de.stustapay.api.models.Till](docs/Till.md)
 ...
 - [de.stustapay.api.models.UpdateUserPayload](docs/UpdateUserPayload.md)
