...
create table if not exists shared_topup_link (
...
create index if not exists shared_topup_link_customer_account_id_idx on shared_topup_link (customer_account_id);

create table if not exists shared_topup_order (
...
create index if not exists shared_topup_order_customer_account_id_idx on shared_topup_order (customer_account_id);
