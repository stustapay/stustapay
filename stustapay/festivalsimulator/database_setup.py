        ...
        async with self.db_pool.acquire() as conn:
            ...
            event_node = await create_event(
                ...
                event=NewEvent(
                    ...
                    email_enabled=True,
                    email_default_sender="stustapaytest@stusta.de",
                    email_smtp_host="mail.stusta.de",
                    email_smtp_port=465,
                    email_smtp_username=None,
                    email_smtp_password=None,
                    payout_done_subject="[StuStaPay] Payout Completed",
                    payout_done_message="Thank you for your patients. The payout process has been completed and the funds should arrive within the next days to your specifed bank account.",
                    payout_registered_subject="[StuStaPay] Registered for Payout",
                    payout_registered_message="Thank you for being part of our festival. Your remaining funds are registered for payout. They will be transfered to the specified bank account in our next manual payout. You will receive another email once we transfered the funds.",
                    payout_sender=None,
                ),
            )
