...
async def list_till_profiles(token: CurrentAuthToken, till_service: ContextTillService, node_id: Optional[int] = None):
...
async def create_till_profile(
    profile: NewTillProfile, token: CurrentAuthToken, till_service: ContextTillService, node_id: Optional[int] = None
):
...
async def get_till_profile(
    profile_id: int, token: CurrentAuthToken, till_service: ContextTillService, node_id: Optional[int] = None
):
