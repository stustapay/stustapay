...
class DieboldNixdorfUSBTSE(TSEHandler):
    def __init__(self, name: str, config: DieboldNixdorfUSBTSEConfig):
        ...
        self._TSEDescription: typing.Optional[str] = None
        self._CertificateDate: typing.Optional[str] = None
    ...
    async def run(self, start_result: asyncio.Future[bool]):
        async with contextlib.AsyncExitStack() as stack:
            try:
                ...
                self._TSEDescription = device_status["TSEDescription"]
                self._CertificateDate = device_status["CertificateDate"]
    ...
    def get_master_data(self) -> TSEMasterData:
        ...
        assert self._TSEDescription is not None
        assert self._CertificateDate is not None
        ...
        return TSEMasterData(
            ...
            tse_CertificateDate=self._CertificateDate,
            tse_TSEDescription=self._TSEDescription,
