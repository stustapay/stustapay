...
class Transaction:
    # client id of the PoS terminal from which the transaction originates
    client_id: str
...
class TSEHandler(abc.ABC):
    ...
    async def register_client_id(self, client_id: str):
        ...
        This enables the TSE to sign transactions for this client ID in the future.
        """
        raise NotImplementedError()
    ...
    async def deregister_client_id(self, client_id: str):
        ...
        This means that the TSE will no longer be able to sign transactions
        from this Client ID in the future.
        """
        pass

    @abc.abstractmethod
    async def sign_transaction(self, transaction: Transaction) -> TransactionSignature:
        """
