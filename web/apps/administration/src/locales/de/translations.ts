...
export const translations: NestedPartialAsStrings<Translations> = {
  ...
  userTag: {
    ...
    secret: "Tag Secret",
    secretRequired: "Bitte vor dem Erstellen ein Tag-Secret auswählen",
    noSecretConfigured: "Für dieses Ereignis ist noch kein Tag-Secret konfiguriert. Bitte zuerst ein Secret anlegen.",
    create: "Benutzer-Tag erstellen",
    createButton: "Benutzer-Tag erstellen",
    createFailed: "Erstellen der Benutzer-Tags fehlgeschlagen",
    uploadPinCsv: "CSV mit Tag-PINs hochladen",
    uploadPinCsvDescription:
      'Verwenden Sie das Grid für direkte Eingabe oder Copy/Paste aus Excel bzw. Google Sheets. CSV bleibt als Fallback mit den Spalten "pin" (erforderlich), "uid" (optional), "is_vip" (optional), "comment" (optional) und "group_tag" (optional) verfügbar.',
    ...
    accountCreationBlocked: "Kontoerstellung für dieses Tag sperren",
    accountCreationBlockedEnabled: "Kontoerstellung für dieses Tag gesperrt",
    accountCreationBlockedDisabled: "Kontoerstellung für dieses Tag wieder freigegeben",
    accountCreationBlockedUpdateFailed: "Sperrstatus für die Kontoerstellung konnte nicht aktualisiert werden",
    ...
    grid: {
      ...
      validationRow: "Zeile {{row}}: {{message}}",
    },
    gridErrors: {
      noRows: "Mindestens eine Tag-Zeile hinzufügen",
    ...
    columnMapping: {
      ...
      mappingApplied: "CSV-Zeilen wurden in das Grid importiert",
  ...
  sumup: {
    ...
    noTransactions: "SumUp hat fuer den aktuell verbundenen Haendler keine Transaktionen zurueckgegeben.",
    transactionsLoadFailed: "Laden der SumUp-Transaktionen fehlgeschlagen: {{reason}}",
    noCheckouts: "SumUp hat fuer die aktuelle Abfrage keine Checkouts zurueckgegeben.",
    checkoutsLoadFailed: "Laden der SumUp-Checkouts fehlgeschlagen: {{reason}}",
    transaction: {
  ...
  settings: {
    ...
    sumup: {
      ...
      linkLoadErrorTitle: "Fehler beim Laden des SumUp-Verbindungsstatus",
      linkConnected: "Dieser Knoten ist mit einem SumUp-Haendler verbunden.",
      linkNotConnected: "Dieser Knoten hat noch keine SumUp-Haendlerverbindung.",
      connect: "Mit SumUp verbinden",
      reconnect: "Neu mit SumUp verbinden",
      disconnect: "Trennen",
      disconnectSuccess: "SumUp-Haendlerverbindung entfernt",
      disconnectFailed: "Entfernen der SumUp-Haendlerverbindung fehlgeschlagen: {{reason}}",
      merchantName: "Haendlername",
      linkedEventCount: "Verknuepfte Events",
      linkedEventCountValue: "{{count}} untergeordnete Events koennen diese Verbindung wiederverwenden.",
      resolvedLinkSummary: "Dieses Event nutzt den SumUp-Haendler {{merchantCode}} ueber {{nodeName}}.",
      noResolvedLink: "Fuer dieses Event ist keine aktive SumUp-Haendlerverbindung verfuegbar.",
      legacyFallbackNotice:
        "Dieses Event hat noch veraltete SumUp-Zugangsdaten. Verschiebe die Haendlerverbindung auf den Elternknoten, um sie fuer mehrere Events gemeinsam zu nutzen.",
      legacyStoredButUnusedNotice:
        "Dieses Event hat noch veraltete SumUp-Zugangsdaten gespeichert. Aktuell wird aber die Verbindung vom Elternknoten verwendet; die alten Event-Daten werden ignoriert.",
      clearLegacyButton: "Legacy-Zugangsdaten loeschen",
      clearLegacyConfirmTitle: "Legacy-SumUp-Zugangsdaten loeschen",
      clearLegacyConfirmContent:
        "Alle alten SumUp-Zugangsdaten auf diesem Event werden entfernt, inklusive Merchant-Code, API-Key und OAuth-Refresh-Token. Die aktuelle Knotenverbindung bleibt erhalten.",
      clearLegacySuccess: "Legacy-SumUp-Zugangsdaten wurden geloescht",
      clearLegacyFailed: "Loeschen der Legacy-SumUp-Zugangsdaten fehlgeschlagen: {{reason}}",
      connectionSource: "Verbindungsquelle",
      sourceNode: "Konfiguriert auf Knoten",
      sourceNodeLink: "Geerbte Knotenverbindung",
      sourceLegacyOauth: "Legacy-Event-OAuth",
      sourceLegacyApiKey: "Legacy-Event-API-Key",
      sourceUnavailable: "Keine aktive Verbindung",
      openConnectionSettings: "Verbindungseinstellungen oeffnen",
    },
    mdm: {
      tabLabel: "MDM / Konnektivität",
      description: "Konfiguriert einen WLAN-Vorschlag für Headwind-verwaltete Geräte dieses Ereignisses.",
      headwindOnlyNotice: "Dieser WLAN-Vorschlag wird nur an Headwind-verwaltete Geräte ausgeliefert.",
      wifiSsid: "WLAN-SSID",
    ...
    email: {
      ...
      invitationTemplates: "Einladungsvorlagen",
  ...
  user: {
    ...
    passwordsDontMatch: "Die Passwoerter stimmen nicht ueberein",
    changePassword: {
  ...
  customer: {
    ...
    tagSwap: {
      tab: "Tag-Tausch",
      title: "Tag-Tausch",
      open: "Tag-Tausch öffnen",
      description:
        "Weise ein Kundenkonto auf ein anderes Tag um. Ziel-Tags mit leerem Stub-Konto können wiederverwendet werden.",
      quickActionDescription:
        "Suche Quell- und Ziel-Tag per Autovervollständigung und sperre das alte Tag bei Bedarf direkt mit.",
      sourceLabel: "Quell-Tag",
      targetLabel: "Ziel-Tag",
      searchPlaceholder: "Nach PIN, UID oder Kommentar suchen",
      sourceHelp: "Es werden nur aktuell einem Kundenkonto zugeordnete Tags angeboten.",
      targetHelp: "Es werden nur direkt nutzbare Tags und wiederverwendbare Stub-Konten angezeigt.",
      sourceCandidateHint: "Aktiv zugeordnetes Kunden-Tag",
      commentLabel: "Kommentar",
      blockSourceLabel: "Altes Tag nach dem Tausch für neue Kontoerstellung sperren",
      submit: "Tag tauschen",
      success: "Tag-Tausch erfolgreich. Aktives Kundenkonto: #{{accountId}}",
      submitFailed: "Tag-Tausch fehlgeschlagen",
      searchFailed: "Tag-Suche fehlgeschlagen",
      accountLabel: "Konto #{{accountId}}",
      status: {
        direct: "Direkt nutzbar",
        reuseStub: "Nutzbar über Wiederverwendung des Ziel-Kontos",
        unavailable: "Nicht nutzbar",
      },
      reason: {
        blocked_from_account_creation: "Für dieses Tag ist die Kontoerstellung gesperrt.",
        tag_assigned_to_user: "Dieses Tag ist bereits einem Benutzer zugeordnet.",
        tag_has_previous_association: "Dieses Tag hat bereits eine frühere Konto-Zuordnung.",
        target_account_is_not_private: "Das Ziel-Konto ist kein privates Kundenkonto.",
        target_account_in_use: "Das Ziel-Konto wurde bereits genutzt und kann nicht wiederverwendet werden.",
      },
    },
