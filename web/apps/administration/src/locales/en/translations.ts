export const translations = {
  ...
  sumup: {
    ...
    transactions: "Transactions",
    noTransactions: "SumUp returned no transactions for the currently connected merchant.",
    transactionsLoadFailed: "Loading SumUp transactions failed: {{reason}}",
    noCheckouts: "SumUp returned no checkouts for the current query.",
    checkoutsLoadFailed: "Loading SumUp checkouts failed: {{reason}}",
    transaction: {
  ...
  settings: {
    ...
    sumup: {
      ...
      linkLoadErrorTitle: "Error loading SumUp connection status",
      linkConnected: "This node is connected to a SumUp merchant.",
      linkNotConnected: "This node does not have a SumUp merchant connection yet.",
      connect: "Connect with SumUp",
      reconnect: "Reconnect with SumUp",
      disconnect: "Disconnect",
      disconnectSuccess: "SumUp merchant link removed",
      disconnectFailed: "Removing the SumUp merchant link failed: {{reason}}",
      merchantName: "Merchant name",
      linkedEventCount: "Linked events",
      ...
      clearLegacyConfirmTitle: "Delete legacy SumUp credentials",
      clearLegacyConfirmContent:
        "This removes all old SumUp credentials from the event, including merchant code, API key, and OAuth refresh token. The current node connection remains unchanged.",
      clearLegacySuccess: "Legacy SumUp credentials deleted",
      clearLegacyFailed: "Deleting legacy SumUp credentials failed: {{reason}}",
      connectionSource: "Connection source",
      sourceNode: "Configured at node",
      sourceNodeLink: "Inherited node link",
      sourceLegacyOauth: "Legacy event OAuth",
      sourceLegacyApiKey: "Legacy event API key",
      sourceUnavailable: "No active connection",
