export const translations = {
  ...
  dsfinvk: "DSFinV-K",
  dsfinvkExport: {
    title: "Fiscal Exports",
    dsfinvkTitle: "DSFinV-K Export",
    dsfinvkDescription: "Download the DSFinV-K ZIP archive containing cash register and TSE transaction data.",
    ao146aTitle: "AO146A Export",
    ao146aDescription: "Download the ELSTER AO146A XML file for registering cash recording systems.",
    shutdownDate: "Shutdown date (optional)",
    shutdownDateHelp: "Leave empty if the systems are still in operation.",
    downloadDsfinvk: "Download DSFinV-K ZIP",
    downloadAo146a: "Download AO146A XML",
    exportDsfinvkError: "Error downloading DSFinV-K export",
    exportAo146aError: "Error downloading AO146A export",
  },
  preview: "Preview",
  ...
  userTag: {
    ...
    restriction: "User tag variant",
    type: "User tag variant",
    variants: "Variants",
    ...
    uploadPinCsvDescription:
      'Csv with columns "pin" (required) and optional "variants" (comma-separated variant names). If a row has no variants, the batch variants above are used.',
    batchVariants: "Batch variants",
    batchVariantsDescription: "Applied to all imported tags unless overridden per CSV row",
    batchVariantNames: "Batch variant names",
    batchVariantNamesDescription: "Selected batch variants for this import",
    batchTypeDescription: "Applied to all imported tags unless a row specifies its own type in the CSV.",
    batchVariant: "Batch variant",
    batchVariantDescription: "Applied to all imported tags unless a row specifies its own variant in the CSV.",
    variant: "Variant",
    exportCsv: "Export CSV",
    excludeActivated: "Exclude activated tags",
    exportVariants: "Variants",
    exportVariantsDescription:
      "Only export tags with at least one of the selected variants. Leave empty to include all.",
    exportError: "Error exporting user tags",
    willCreate: "Will create {{nTags}} new user tags",
    firstNTags: "The following are the first {{actualNum}} tags which will be created",
  },
  userTagVariant: {
    title: "User Tag Variants",
    name: "Name",
    description: "Description",
    priority: "Priority",
    create: "Create user tag variant",
    update: "Update user tag variant",
    delete: "Delete user tag variant",
    deleteDescription: "Are you sure you want to delete this user tag variant?",
    tab: "Variants",
  },
  userTagSecret: {
  ...
  cashier: {
    ...
    cashierInfo: "Cashier information",
  },
  shift: {
    id: "ID",
    comment: "Comment",
  ...
  overview: {
    ...
    autoUpdateOff: "Off",
    autoUpdate30s: "30s",
    autoUpdate1min: "1 min",
    autoUpdate5min: "5 min",
    autoUpdate30min: "30 min",
    entryStats: "Entry Stats",
    topUpStats: "Top Up Stats",
    payOutStats: "Pay Out Stats",
    paymentMethodDistribution: "Payment type distribution",
    freeTicketStats: "Free tickets",
    freeTicketsIssued: "Issued",
    productTotal: "Product (total)",
    revenue: "Revenue",
    totalSalesRevenue: "Total revenue through sales",
    productSalesStats: "Product sales stats",
    depositProductStats: "Stats for deposit products",
  ...
  product: {
    ...
    restrictions: "Blocked user tag variants",
    userTagVariants: "User tag variants",
    isLocked: "Locked",
  ...
  taxRateTypes: {
    regular_vat: "Regular VAT",
    reduced_vat: "Reduced VAT",
    no_tax: "No tax",
    transparent: "Transparent (other cash register)",
  },
  ...
  till: {
    ...
    tills: "Tills",
    overview: "Overview",
    configuration: "Till configuration",
    showUnassignedRegisters: "Show unassigned registers",
    id: "ID",
    name: "Name",
    profile: "Profile",
    description: "Description",
  ...
  button: {
    ...
    noAvailableButtons: "No available buttons",
    noAssignedButtons: "No buttons assigned yet",
    assign: "Assign",
    moveUp: "Move up",
    moveDown: "Move down",
    name: "Name",
  ...
  register: {
    ...
    stockingTotal: "Total",
    stockingMakeup: "Stocking makeup",
    stockingMakeupDenomination: "Denomination",
    stockingMakeupValuePerUnit: "Per unit",
    stockingMakeupQuantity: "Qty",
    stockingMakeupAmount: "Amount",
    stockingMakeupEmpty: "No denominations configured",
    denominations: {
      euro200: "200€",
      euro100: "100€",
      euro50: "50€",
  ...
  customer: {
    ...
    swapTag: "Swap customer tag",
    sourceTagPin: "Source tag PIN",
    targetTagPin: "Target tag PIN",
    sourceTagAssignedOnly: "Search shows only tags currently assigned to a customer account",
    targetTagUnassignedOnly: "Search shows only unassigned tags that have never been used before",
    swapTagSubmit: "Swap tag",
    swapTagSuccess: "Successfully swapped customer tag",
    swapTagError: "Failed to swap customer tag",
