export const translations = {
  ...
  resources: {
    users: {
      name_one: "User",
      name_other: "Users",
      forcedCaseName_one: "user",
      forcedCaseName_other: "users",
      fields: {
        id: "ID",
        login: "Login",
        description: "Description",
    ...
    tills: {
      name_one: "Till",
      name_other: "Tills",
      forcedCaseName_one: "till",
      forcedCaseName_other: "tills",
      fields: {
        id: "ID",
        name: "Name",
        profile: "Profile",
        description: "Description",
        tse_id: "TSE ID",
        logged_in: "Terminal registered",
        tse_serial: "TSE Serial",
        logout: "Unregister till",
        terminal_id: "Terminal",
        profile_id: "Profile",
        current_cash_register_balance: "Current cash register balance",
        current_cash_register_name: "Current cash register name",
        active_user_id: "Logged in user",
        z_nr: "Z Nr.",
    ...
    till_profiles: {
      name_one: "Profile",
      name_other: "Profiles",
      forcedCaseName_one: "profile",
      forcedCaseName_other: "profiles",
    },
    till_layouts: {
      name_one: "Layout",
      name_other: "Layouts",
      forcedCaseName_one: "layout",
      forcedCaseName_other: "layouts",
    },
    till_buttons: {
      name_one: "Button",
      name_other: "Buttons",
      forcedCaseName_one: "button",
      forcedCaseName_other: "buttons",
    },
    till_registers: {
      name_one: "Register",
      name_other: "Registers",
      forcedCaseName_one: "register",
      forcedCaseName_other: "registers",
    },
    till_register_stockings: {
      name_one: "Stocking",
      name_other: "Stockings",
      forcedCaseName_one: "stocking",
      forcedCaseName_other: "stockings",
    },
    tses: {
      name_one: "Tse",
      name_other: "Tses",
      forcedCaseName_one: "tse",
      forcedCaseName_other: "tses",
      fields: {
        id: "ID",
        name: "Name",
        type: "Type",
        ...
        process_data_encoding: "Data Encoding",
      },
    },
    tickets: {
      name_one: "Ticket",
      name_other: "Tickets",
      forcedCaseName_one: "ticket",
      forcedCaseName_other: "tickets",
      fields: {
        id: "ID",
        name: "Name",
        product: "Product",
        ...
        initial_top_up_amount: "Initial top up amount",
    ...
    products: {
      name_one: "Product",
      name_other: "Products",
      forcedCaseName_one: "product",
      forcedCaseName_other: "products",
      fields: {
        id: "ID",
        name: "Name",
        price: "Price",
        price_in_vouchers: "Price in Vouchers",
    ...
    terminals: {
      name_one: "Terminal",
      name_other: "Terminals",
      forcedCaseName_one: "terminal",
      forcedCaseName_other: "terminals",
      fields: {
        id: "ID",
        name: "Name",
        description: "Description",
        ...
        is_registered: "Terminal registered",
