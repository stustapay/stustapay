export const translations = {
  ...
  customer: {
    ...
    searchCustomersDescription: "Find a specific visitor, inspect their balance, and open payout details.",
    payoutRunsDescription: "Review pending payout totals and open existing payout runs.",
    accountsDescription: "Handle balance operations and account-level support actions.",
    userTagsDescription: "Investigate wristband and account mapping issues.",
