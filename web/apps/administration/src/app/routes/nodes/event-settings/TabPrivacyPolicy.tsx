      ...
      {(formik) => (
        <Form onSubmit={formik.handleSubmit}>
          <Stack spacing={2}>
            ...
            <FormGroup>
              <FormControlLabel
                label={t("settings.privacyPolicy.preview")}
            ...
            <FormControl error={!!formik.errors.translation_texts}>
              <MarkdownEditor
                ...
                value={formik.values.translation_texts[language]?.["privacy_policy"] ?? ""}
                onChange={(val) => {
                  const newSettings = updateTranslationTexts(formik.values.translation_texts, language, "privacy_policy", val);
