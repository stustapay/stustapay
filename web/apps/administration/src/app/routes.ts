...
export const OrderRoutes = new RouteBuilder("orders", ["node_administration", "can_book_orders"], "account");
...
export const CustomerRoutes = new RouteBuilder("customers", ["node_administration", "customer_management"], "account");
