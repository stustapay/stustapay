...
export type NodeResourceDatagridProps = DatagridProps;
...
export const NodeResourceDatagrid: React.FC<NodeResourceDatagridProps> = ({ children, ...props }) => {
  const createPath = useCreateNodePath();
  ...
  return (
    <Datagrid rowClick={handleRowClick} {...props}>
      {children}
      <TableActions />
    </Datagrid>
  );
