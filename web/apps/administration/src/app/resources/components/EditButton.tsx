...
import { Button, ButtonProps, RaRecord, useResourceContext, useRecordContext } from "react-admin";
 ...
 * );
 */
export const EditButton = <RecordType extends RaRecord = any>(props: EditButtonProps<RecordType>) => {
  const { icon = defaultIcon, label = "ra.action.edit", scrollToTop = true, className, ...rest } = props;
