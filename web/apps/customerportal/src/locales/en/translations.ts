export const translations = {
  ...
  index: {
    sharedTopupHint:
      "On the <1>Group top-up</1> page you can create a shareable link so others can add money to this chip.",
  },
  balance: "Balance",
  ...
  order: {
    ...
    sharedTopupContributor: "Top-up by: {{name}}",
    orderType: {
      sale: "Purchase",
  ...
  topup: {
    ...
    shared: {
      title: "Group Top-Up",
      description: "Top up the group balance for {{eventName}}.",
      ownerTitle: "Group Top-Up",
      ownerDescription: "Create a top-up-only link for people who should add money to this chip. Active links remain valid until revoked.",
      createLink: "Create link",
      createFailed: "Could not create link.",
      created: "Link created and copied.",
      label: "Label",
      noLabel: "No label",
      link: "Group top-up link",
      copy: "Copy link",
      copied: "Link copied.",
      copyFailed: "Could not copy link.",
      oneTimeLinkNotice: "Copy this link now. For security, it cannot be shown again after you leave or reload this page.",
      replace: "Replace link",
      replaced: "Link replaced and copied.",
      replaceFailed: "Could not replace link.",
      revoke: "Revoke link",
      ...
      contributionsTitle: "Group top-ups",
      noContributions: "No top-ups yet.",
      name: "Your name",
