export const translations = {
  ...
  index: {
    sharedTopupHint:
      "On the <1>Shared top-up</1> page you can create a link so others can add money to your chip.",
  },
  balance: "Balance",
  ...
  order: {
    ...
    sharedTopupContributor: "Shared top-up by: {{name}}",
    orderType: {
      sale: "Purchase",
  ...
  topup: {
    ...
    description: "You can top up your balance online with SumUp here.",
    ...
    next: "Next",
    shared: {
      title: "Shared Online Top-Up",
      description: "Top up the shared balance for {{eventName}}.",
      ownerTitle: "Shared top-up link",
      ownerDescription: "Create a top-up-only link for people who should add money to this chip. They can only enter their name, choose an amount, and pay.",
      createLink: "Create shared link",
      createFailed: "Could not create shared link.",
      created: "Shared link created and copied.",
      link: "Shared top-up link",
      copy: "Copy link",
      copied: "Link copied.",
      copyFailed: "Could not copy link.",
      revoke: "Revoke shared link",
      revoked: "Shared link revoked.",
      revokeFailed: "Could not revoke shared link.",
      createdAt: "Created",
      status: "Status",
      actions: "Actions",
      activeStatus: "Active",
      revokedStatus: "Revoked",
      contributionsTitle: "Shared top-ups",
      noContributions: "No shared top-ups yet.",
      name: "Your name",
      nameRequired: "Name is required",
      nameTooLong: "Name is too long",
      invalidLink: "This shared top-up link is invalid or has been revoked.",
      success: "The shared chip balance has been topped up.",
      contributionStatus: {
        pending: "Pending",
        booked: "Paid",
        cancelled: "Cancelled",
