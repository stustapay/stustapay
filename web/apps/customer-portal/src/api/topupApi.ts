...
export const SumupConfirmScheckoutResponseSchema = z.object({
  id: z.string(),
...
export type SumupConfirmScheckoutResponse = z.infer<typeof SumupConfirmScheckoutResponseSchema>;
...
export const topupApi = createApi({
  ...
  tagTypes: [],
  endpoints: (builder) => ({
    createCheckout: builder.mutation<SumupConfirmScheckoutResponse, { amount: number }>({
      query: (payload) => ({
