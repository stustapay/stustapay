...
export const translations: NestedPartialAsStrings<Translations> = {
  ...
  payoutInfo: "Um dein Restguthaben nach dem Festival zu erhalten, <1>trage bitte deine Bankdaten hier ein</1>. Die nächste Auszahlung findet am 19. Juni statt.",
  about: "Impressum",
  contact: "Kontakt",
